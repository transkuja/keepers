...
public class SeqMultiCharacters : Sequence
{
    ...
    public class ShowCurrentCharacterAvatar : Step
    {
        ...
        public void Message_fct()
        {
            ...
            if (feedback == null)
            {
                ...
                feedback.GetComponent<FlecheQuiBouge>().PointToPoint = seqMultiCharacters.selectedKeepersPanel.transform.GetChild(0).GetChild(0).GetChild(0).position;
    ...
    public override void Init()
    {
        ...
        Etapes.Add(new TutoManager.Message(pawnMrResetti, "Each one of them has his own action points, inventory and specificities."));
        Etapes.Add(new ShowCurrentCharacterAvatar("You can see the character actually selected here."));
