...
public class Opener2 : MonoBehaviour {
    ...
    public void UpdateState()
    {
        ...
        {
            if (animatorCard.GetCurrentAnimatorStateInfo(0).IsName("Idle_02"))
            {
                Unfold();
            }
        }
